  ...
  render() {
    return (
      ...
      <div className="container">
        ...
        <h4 className="subTitle">You will need your session ID to continue next time.</h4>
      <form className="inputForm w-1/3 mx-auto"> 
          <label className="text-xl text-white font-nunito font-medium"> Your Session ID </label>
          <input className="m-6 w-3/4 pl-4 pr-2 pt-2 pb-2 text-center block rounded-full font-nunito" id="sessionID" type="text" readonly value={this.state.value}/>        
          <GenericButton
              buttonType="white"
